...
@section('content')
<div class="container">
    <h3>Add a train carriage</h3>
    <hr>
    <!-- Display Validation Errors -->
    @include('common.errors')
    @include('common.status')
    <!-- edit form column -->
    <form id="pers-form" action="{{ url('addCarriage') }}" method="POST" class="form-horizontal">
        {{ csrf_field() }}
        <div class="col-sm-6 personal-info">
            
            <h4>Identification</h4>
            <div class="form-group">
                <label class="col-lg-3 control-label">Carriage id:</label>
                <div class="col-lg-8">
                    <input class="form-control" type="text" name="carriageId" value="{{ old('carriageId') }}">
                </div>
            </div>
            <div class="form-group">
